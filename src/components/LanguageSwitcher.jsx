  ...
  return (<div>
    ...
    <div className="menu-languages">
      ...
      <div className="menu-languages-items">
        ...
        <div className="menu-languages-item border shadow rounded ">
          <div className='d-flex flex-column align-items-center image-content'>
            <Image src={`/languajes/flags/be.svg`} alt="Belgian" className="flag rounded w-100 px-1" data-language="be" onClick={switchLanguage} width={100} height={70} />
            Belgian
          </div>
        </div>
        ...
        <div className="menu-languages-item border shadow rounded ">
          <div className='d-flex flex-column align-items-center image-content'>
            <Image src={`/languajes/flags/tr.svg`} alt="Belgian" className="flag rounded w-100 px-1" data-language="tr" onClick={switchLanguage} width={100} height={70} />
            Turkish
          </div>
        </div>
        ...
        <div className="menu-languages-item border shadow rounded ">
          <div className='d-flex flex-column align-items-center image-content'>
            <Image src={`/languajes/flags/sv.svg`} alt="Belgian" className="flag rounded w-100 px-1" data-language="sv" onClick={switchLanguage} width={100} height={70} />
            Swedish
          </div>
        </div>
        ...
        <div className="menu-languages-item border shadow rounded ">
          <div className='d-flex flex-column text-center align-items-center image-content'>
            <Image src={`/languajes/flags/ca.svg`} alt="English (Canada)" className="flag rounded w-100 px-1" data-language="ca" onClick={switchLanguage} width={100} height={70} />
            English (Canada)
          </div>
        </div>
