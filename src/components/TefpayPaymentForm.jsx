...
export const TefpayPaymentForm = () => {
    ...
    return (<>
        ...
        <form className="p-2 mb-2 payment-form" role="form" id="tefpayData" autoComplete="true" >
            ...
            <input type="hidden" name="Ds_Merchant_UrlOK" value={ `https://${hostname}/api/thanks/${paymentToken}-${lang}?user_email=${user_email}&user_name=${user_name}&password=${user.uid}&country=${lang}`}/>
