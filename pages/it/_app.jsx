...
function PersonsFinder({ Component, pageProps }) {
  return (<>
    ...
    <Script type="text/javascript" src="/libs/owl-carousel/owl.carousel.min.js" strategy='afterInteractive' />
    <Script type="text/javascript" src="/libs/waypoints/jquery.waypoints.min.js" strategy='afterInteractive' />
    <Script type="text/javascript" src="/libs/animateNumber/jquery.animateNumber.min.js"  strategy='afterInteractive' />
